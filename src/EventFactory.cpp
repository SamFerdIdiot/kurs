...
GameEvent createOutOfFuel() {
    GameEvent event;
    event.id = "out_of_fuel";
    event.type = EventType::RESOURCE;
    event.title = "⛽ КРИТИЧНО: ТОПЛИВО НА НУЛЕ";
    event.description = "Двигатель захлебнулся и заглох. Стрелка указателя топлива упёрлась в ноль. "
                       "Машина встала посреди дороги. Ближайшая заправка в нескольких километрах. "
                       "Нужно срочно решать, что делать.";
    event.oneTimeOnly = false;
    event.weight = 1.0f;
